    ...
    QObject( parent )
{
    ...
    QString faceClassifier( Config::getInstance()->getString("APPLICATION_PATH") );
    faceClassifier.append( Config::getInstance()->getString("CLASSIFIERS_PATH") );
    faceClassifier.append( "face.xml" );
    string face = faceClassifier.toStdString();

    QString smileClassifier( Config::getInstance()->getString("APPLICATION_PATH") );
    smileClassifier.append( Config::getInstance()->getString("CLASSIFIERS_PATH") );
